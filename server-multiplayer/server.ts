...
app.get('/api/stats/:playerName', (req: Request, res: Response) => {
    try {
        const playerName = decodeURIComponent(String(req.params.playerName));
...
app.get('/api/global-stats', (req: Request, res: Response) => {
    try {
